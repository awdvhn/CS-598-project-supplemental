function [time, F_deNoise, x_acc, v_acc, a_acc, d, c,...
    iFstart, iFend, fc_LowPass] = computeDisp_AccRAWarr_R0_DetrendFilter(timeRAW, Fraw_Hammmer, aRAW_acc)
...
[f_FFTvelDet, aFFT_velDet] = regFFT(time, detrend(v_accRAW));
CusFigure('Frequency [Hz]',...
